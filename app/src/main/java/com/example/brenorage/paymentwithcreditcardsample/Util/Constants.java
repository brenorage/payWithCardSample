package com.example.brenorage.paymentwithcreditcardsample.Util;
...
public final class Constants {
    ...
    public static final int CONN_NOT_FOUND = 404;
    public static final int CONN_INTERNAL_ERROR = 500;

    //Activities results contants
